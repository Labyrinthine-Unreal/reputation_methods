...
for i in range(0,contract_OG.functions.totalSupply().call()):
    ...
    # print(i)
    infura_url = "https://goerli.infura.io/v3/4cb849430aaa4b82bb8360011eb397e9"
    #	 infura_url = 'wss://ropsten.infura.io/ws/v3/89f69d97c5c44c35959cc4d15c0f0531'
    web3 = Web3(Web3.HTTPProvider(infura_url))
    web3.middleware_onion.inject(geth_poa_middleware, layer=0)
    ...
    contract = '0xAeA629A1318Fb17197eF115c019bf87422331830'
    ...
    transfer = contract.functions.transfer(holders,(daos_owned*100)//10*.666*10).buildTransaction({'chainId': 5,'gas':500000,'gasPrice': web3.toWei('40.875000015', 'gwei'), 'nonce': nonce})
    signed_tx2 = web3.eth.account.signTransaction(transfer, mint_key)
    # latestBlock()
